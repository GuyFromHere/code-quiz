...
function getResult(correct) {
  ...
  // show messageArea after fade out
  ...
  // Now that we've shown it, fade messageArea
...
function getScore() {
  ...
  var buttonClearStorage = document.createElement("button");
  ...
  buttonReset.setAttribute("onclick", "location.reload();");
  board.appendChild(buttonReset);

  buttonClearStorage.setAttribute("id", "buttonClearStorage");
  buttonClearStorage.textContent = "Clear Storage";
  buttonClearStorage.setAttribute("onclick", "localStorage.clear();");
  board.appendChild(buttonClearStorage);
}
